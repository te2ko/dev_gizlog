...
<div class="main-wrap">
  <div class="container">
    {!! Form::open(['route' => ['question.confirm']]) !!}
      ...
      {!! Form::select('' => 'tag_category_id', ['Select category', 1 => 'FRONT', 2 => 'BACK', 3 => 'INFRA', 4 => 'OTHERS'], $input->tag_category_id, ['class' => 'form-control selectpicker form-size-small', 'id' => 'pref_id']) !!}
      ...
      <div class="form-group {{ !empty($errors->first('content')) ? 'has-error' : '' }}">
        <textarea class="form-control" placeholder="Please write down your question here..." name="content" cols="50" rows="10">{!! nl2br(e($report->content)) !!}</textarea>
